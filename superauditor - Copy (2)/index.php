<?php 
    ...
    { 
        ...
        { 
			...
			$query_3= "UPDATE `superauditor_details` SET `last_login_date`='$last_login_date',`user_ip`='$hostname'  WHERE username = '$name' and password= '$pass'";
...
<body>
  <section class="container">
    <div class="login">
      <h1>ORLIV SUPERAUDITOR LOGIN</h1>
