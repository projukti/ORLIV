...
<body>
    ...
    <a href="actionpdf.php?state_name=<?php echo $state_name?>&branch_name=<?php echo $branch_code;?>" target="_blank"><img src="image/pdf.png" height="48" width="48"></a></span></div>
