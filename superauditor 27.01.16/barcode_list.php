...
<div class="container">
<?php 
//$sel=mysql_query("select * from audit_physical_stock_details where audt_code='".$_REQUEST['audt_code']."' LIMIT 0,65");
$sel=mysql_query("select * from audit_physical_stock_details where audt_code='".$_REQUEST['audt_code']."' and id between 9766 AND 9797");
//$sel=mysql_query("select * from audit_physical_stock_details where audt_code='".$_REQUEST['audt_code']."' and id =3885");
...
if($count==0){?>                     
    ...
    <div class="block">
      ...
      <canvas id="canvasTarget<?php echo $i;?>" ></canvas>
    </div>
    <?php if(($i)%65 == 0) echo '<div style="height:90px; float:left; width:100%; clear:both;"></div>';?>
<?php }}?>    
</div>
</body>
</html>