...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="10" height="60" align="center" valign="middle">&nbsp;</td>
    <td width="70" height="60" align="left" valign="middle" class="style7">&nbsp;</td>
    <td width="10" height="60" align="center" valign="middle">&nbsp;</td>
    <td width="60" height="60" align="center" valign="middle">&nbsp;</td>
    <td width="10" height="60" align="center" valign="middle">&nbsp;</td>
    <td width="50" height="60" align="center" valign="middle">&nbsp;</td>
    <td width="10" height="60" align="center" valign="middle">&nbsp;</td>
    <td width="80" height="60" align="center" valign="middle">&nbsp;</td>
  </tr>
  <tr>
...
|<br />
|</td>
    <td width="70" height="60" align="center" valign="middle" class="style3"><span class="style3">Marketing Person</span></td>
    <td width="10" height="60" align="center" valign="middle" class="style3">|<br />
|<br />
|</td>
    <td width="70" height="60" align="center" valign="middle" class="style3"><span class="style3">Operating Person</span></td>
    <td width="10" height="60" align="center" valign="middle" class="style3">|<br />
|<br />
|</td>
...
|</td>
  ...
  <tr>
   ...
   <?php
$select_user = "SELECT * FROM `job_info` Where completion_date between '$from_date'and '$to_date' and ok_complete=1 order by id DESC";
...
|</span></td>
    ...
    <td width="10" height="50" align="center" valign="middle" class="style7"><span class="style3">
|</span></td>
    <td width="70" height="50" align="center" valign="middle" class="style7"><?php echo $post_holder; ?></td>
    <td width="10" height="50" align="center" valign="middle" class="style7"><span class="style3">
|</span></td>
    <td width="70" height="50" align="center" valign="middle" class="style7"><?php echo $consult_operating_person; ?></td>
    <td width="10" height="50" align="center" valign="middle" class="style7"><span class="style3">
|</span></td>
