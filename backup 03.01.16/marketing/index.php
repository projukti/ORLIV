<?php 
    ...
    { 
        ...
        { 
			...
			$query_3= "UPDATE `marketing_details` SET `last_login_date`='$last_login_date',`user_ip`='$hostname'  WHERE username = '$name' and password= '$pass'";
